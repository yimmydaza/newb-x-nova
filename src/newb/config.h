...
#define NL_SATURATION 0.65            // [toggle] 0.0 grayscale ~ 4.0 super saturated
//#define NL_TINT                      // [toggle] enable light/dark tone tinting
#define NL_TINT_LOW  vec3(0.2,0.4,1.3,1.0) // color tint for dark tone
#define NL_TINT_HIGH vec3(1.4,0.8,0.3) // color tint for light tone
...
#define NL_MORNING_SUN_COL vec3(3.0,0.6,0.0)//2.0,1.0,0.0
#define NL_NOON_SUN_COL    vec3(1.0,1.0,0.0)
#define NL_NIGHT_SUN_COL   vec3(1.0,0.6,0.0)//3.0,3.0,2.0
...
/* Fog */
#define NL_FOG 0.5//1.0                 // [toggle] 0.1 subtle ~ 1.0 blend with sky completely
#define NL_MIST_DENSITY 0.18//0.18       // 0.0 no mist ~ 1.0 misty
#define NL_RAIN_MIST_OPACITY 0.7//0.12   // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow
//#define NL_CLOUDY_FOG 0.0//0.1         // [toggle] 0.0 subtle - 0.8 dense fog clouds

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.0,0.6,3.0) //(0.1,0.6,3.0)
#define NL_DAY_HORIZON_COL   vec3(0.1,0.5,1.0) //(0.1,0.5,1.0)

#define NL_NIGHT_ZENITH_COL  vec3(0.0,0.2,0.5)
#define NL_NIGHT_HORIZON_COL vec3(0.002,0.55,1.4)
...
#define NL_DAWN_ZENITH_COL   vec3(0.0,0.2,0.5)
#define NL_DAWN_HORIZON_COL  vec3(0.8,0.5,0.0)
#define NL_DAWN_EDGE_COL     vec3(0.8,0.3,0.0)
...
/* Waving */
#define NL_PLANTS_WAVE 0.04//0.05   // [toggle] 0.02 gentle ~ 0.4 violent
#define NL_LANTERN_WAVE 0.16//0.16   // [toggle] 0.05 subtle ~ 0.4 large swing
#define NL_WAVE_SPEED 2.5//2.8      // 0.5 slow wave ~ 5.0 very fast wave
#define NL_EXTRA_PLANTS_WAVE // [toggle] !dont use! wave using texture coords (1.21.0 vanilla 2048x1024)
#define NL_WAVE_RANGE 16.0//13.0     // 6.0 upto 6 blocks ~ 32.0 upto 32 blocks away (slower)

/* Water */
#define NL_WATER_TRANSPARENCY 0.6 // 0.0 transparent ~ 1.0 normal
#define NL_WATER_BUMP 0.3        // 0.001 plain ~ 0.2 bumpy water
...
#define NL_WATER_TINT vec3(2.0,2.0,2.0)
...
#define NL_UNDERWATER_STREAKS 0.2            // [toggle] 0.8 subtle - 2.0 bright streaks from top
#define NL_UNDERWATER_TINT vec3(2.0,2.0,1.7) // fog tint color when underwater
...
#define NL_GALAXY_DAY_VISIBILITY 0.001    // 0.0 invisible - 1.0 visible
...
#define NL_SUNMOON_SIZE 0.6            // 0.3 tiny ~ 4.0 massive
...
#define NL_ENTITY_BRIGHTNESS     0.8 // 0.1 dark ~ 1.6 bright
//#define NL_ENTITY_EDGE_HIGHLIGHT 0.7 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
